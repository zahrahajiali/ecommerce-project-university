    ...
    <footer className="bg-white py-5 text-[#333] shadow-lg">
      <FooterArea>
        <AboutProjectArea className="w-[30%]">
          ...
          <p>
            این وبسایت برای پروژه دانشگاه آزاد واحد علوم تحقیقات توسط زهرا
            حاجیعلی و برای استاد کارگر مربوط به درس کامپایلر و اصول طراحی نرم
            افزار طراحی و پیاده سازی شده و هیچکدوم از کالاها و نوشته واقعی
            نیستند صرفا برای نمایش در این پروژه و به صورت ماک قرار داده شده اند.
          </p>
        </AboutProjectArea>

        <FooterNav>
          <h2 className="font-bold mb-1">اطلاعات دانشجو</h2>
          <li>نام و نام خانوادگی :زهرا حاجیعلی</li>
          <li>شماره دانشجویی : ۹۸۰۱۱۶۹۸۲</li>
        </FooterNav>
